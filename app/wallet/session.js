...
export class WalletSession {
    constructor(opts) {
        ...
        const [programDirectory, logDirectory, walletDirectory] = window.directories;
        const [openWallet, error] = WalletBackend.openWalletFromFile(this.daemon, walletDirectory + '/proton.wallet', 'hunter2');
